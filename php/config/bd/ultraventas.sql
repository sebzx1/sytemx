...
--
-- Host: localhost
-- Generation Time: Nov 21, 2021 at 12:02 AM
...
INSERT INTO `categorias` (`codigo`, `nombre`, `detalle`, `fechaRegistro`) VALUES
(18, 'Zapatos', '', '2021-06-05 14:24:19'),
(19, 'Arreglo de Computadores', '', '2021-06-05 14:24:58'),
(23, 'Tablet', '', '2021-07-13 22:37:54'),
(24, 'Carnes', '', '2021-07-14 03:37:26'),
(25, 'atunes', 'atun prueba detalle', '2021-08-09 16:32:18');
...
INSERT INTO `clientes` (`codigo`, `identificacion`, `nombres`, `apellidos`, `telefono`, `correo`, `celular`, `ciudad`, `direccion`, `fechaRegistro`) VALUES
(2, 1020435154, 'pepito', 'peres', '3023269337', 'daniel_2490@hotmail.com', '3023269337', 1, '', '2021-06-12 14:20:42'),
(3, 1063143, 'jhosimar de jesus', 'solipa salas', '', 'jhosimar@gmail.com', '30123456789', 417, 'calle lorica', '2021-08-09 16:33:29'),
(4, 1020435154, 'Edward Daniel', 'Garcia', '3023269337', 'daniel_2490@hotmail.com', '3023269337', 1, 'calle 101a 78 13 apt 301, 301 12 de octubre', '2021-10-27 19:00:17'),
(5, 102043515, 'e', 'Garcia', '3023269337', 'ingenieria@ms.com.co', '3023269337', 3, 'cll 81a 80 51, robledo Diamante', '2021-11-19 19:42:30');
...
CREATE TABLE `detalleVentas` (
  `detaVentCod` int(11) NOT NULL,
  `ventCod` int(11) DEFAULT NULL,
  `subCant` int(11) DEFAULT NULL,
  `subCod` int(11) DEFAULT NULL,
  `ventFechaCreacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
INSERT INTO `detalleVentas` (`detaVentCod`, `ventCod`, `subCant`, `subCod`, `ventFechaCreacion`) VALUES
(1, 12, 3, 7, '2021-11-16 18:26:19'),
(2, 0, 3, 7, '2021-11-16 18:26:42'),
(3, 0, 2, 4, '2021-11-16 18:26:42'),
(4, 0, 2, 4, '2021-11-16 18:28:48'),
(5, 15, 3, 4, '2021-11-16 18:29:09'),
(6, 0, 2, 4, '2021-11-16 18:29:26'),
(7, 0, 2, 4, '2021-11-16 18:29:42'),
(8, 0, 3, 4, '2021-11-16 18:30:19'),
(9, 0, 3, 4, '2021-11-16 18:30:31'),
(10, 0, 1, 5, '2021-11-20 19:28:22');
...
INSERT INTO `productos` (`codigo`, `barras`, `sku`, `nombre`, `categoria`, `productoServicio`, `imagen`, `cantidad`, `valor`, `descripcion`, `marca`, `iva`, `fechaVencimiento`, `fechaRegistro`) VALUES
(11, '', '', '4', 23, 'Producto', '11.jpeg', '13', '1000000', 'ni', '', 0, '2021-10-30', '2021-07-13 23:16:25'),
(12, '', '', '4', 23, 'Producto', '12.jpeg', '12', '12000000', 'no hay ', '', 0, '2021-10-21', '2021-07-13 23:18:32'),
(13, '2321212', '3232244', '6', 24, 'Producto', '13.jpeg', '0', '15000', 'Carne de res punta de anca', 'Vaca', 19, '2021-10-15', '2021-07-14 03:38:51'),
(17, '3212', '1212', '7', 25, 'Producto', '17.jpeg', '15', '3400', 'este atun es elmejor', 'van camp', 0, '2021-10-28', '2021-10-27 21:55:03'),
(18, '23', '1212', '3', 19, 'Producto', '18.png', '12', '122', '1212', '12', 12, '2021-11-20', '2021-11-20 16:04:22');
...
INSERT INTO `subcategoria` (`codigo`, `categoria`, `nombreProducto`, `detalle`, `fechaRegistro`) VALUES
(3, 19, 'Adidas Retrive', '', '2021-06-12 01:08:36'),
(4, 23, 'Mac', '', '2021-07-13 23:14:38'),
(5, 24, 'Cerdo', '', '2021-07-14 03:37:35'),
(6, 24, 'Res', '', '2021-07-14 03:37:41'),
(7, 25, 'atun en agua', 'Este es el detalle de subcategoria', '2021-08-09 16:32:36');
...
INSERT INTO `trabajadores` (`codigo`, `identificacion`, `nombres`, `apellidos`, `telefono`, `correo`, `celular`, `ciudad`, `direccion`, `fechaRegistro`) VALUES
(5, 1020435154, 'Daniel', 'Garcia', '3023269337', 'daniel_2490@hotmail.com', '3023269337', 1, 'cll 81a 80 51', '2021-10-27 23:23:02'),
(6, 1020435154, 'Daniel', 'Garcia', '3023269337', 'daniel_2490@hotmail.com', '3023269337', 1, 'cll 81a 80 51', '2021-10-27 23:24:31');
...
INSERT INTO `ventas` (`codigo`, `trabajador`, `cliente`, `fechaVenta`, `producto`, `cantidad`, `valor`, `iva`, `subtotal`, `total`) VALUES
(1, 6, 2, '2021-11-20 19:39:54', NULL, NULL, 0, 0, 122, 122);
...
ALTER TABLE `detalleVentas`
  ADD PRIMARY KEY (`detaVentCod`),
  ADD KEY `subCod` (`subCod`),
  ADD KEY `ventCod` (`ventCod`);
...
ALTER TABLE `ventas`
  ADD PRIMARY KEY (`codigo`),
  ADD KEY `trabajadores` (`trabajador`),
...
--
ALTER TABLE `detalleVentas`
  MODIFY `detaVentCod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`trabajador`) REFERENCES `trabajadores` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`cliente`) REFERENCES `clientes` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ventas_ibfk_3` FOREIGN KEY (`producto`) REFERENCES `productos` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
