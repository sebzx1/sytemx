...
//invoca y almacena en la variable el valor
	...
	if(isset($btnGuardar)){ //si se presiona el boton guardar
		...
		if($identi>0){
			...
			$sql="INSERT INTO trabajadores(identificacion,nombres,apellidos,telefono,correo,celular,direccion,ciudad) VALUES('$identificacion','$nombres','$apellidos','$telefono','$correo','$celular','$direccion','$ciudad')";
...
////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(isset($btnEditar)){ //si se presiona el boton editar
		...
		//actualiza la bd
		$sql="UPDATE trabajadores SET identificacion = '$identificacion',nombres = '$nombres',apellidos = '$apellidos',telefono = '$telefono',celular = '$celular',correo = '$correo',direccion = '$direccion',ciudad = '$ciudad' WHERE codigo = $codigo";
...
<!--------------------------------------------------------------------------------------->
	...
	<article class="contenidoFormularios"> <!-- formulario -->
		...
		<h4 class="text-left">Registro o Edicion de Trabajadores</h4> <!-- nombre de la categoria -->
	...
	$(document).on('click', '.delete', function(e) {		
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: "POST",
					url: "secciones/eliminarTrabajadores.php",
					data: data,
